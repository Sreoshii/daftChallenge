...
# Create DAG showing the 1747 understanding: Lemons → Scurvy Prevention
...
pgm.add_node("scurvy_prevention", "Scurvy\nPrevention", 4.5, 1, aspect=3.0, scale=1.4,
             plot_params={
...
# Create DAG showing the misguided belief: Acid → Bacteria Death → Scurvy Prevention
...
# Create DAG showing the 1928 understanding: Vitamin C → Collagen Synthesis → Scurvy Prevention
...
pgm.add_node("vitamin_c", "Vitamin C", 1, 1, aspect=3.2, scale=1.5,
             plot_params={
...
pgm.add_node("collagen", "Collagen\nSynthesis", 4, 1, aspect=3.2, scale=1.5,
             plot_params={
                 'facecolor': '#87CEEB',  # Sky blue for collagen synthesis
                 'edgecolor': '#4682B4',  # Steel blue border
                 'linewidth': 3,
                 'alpha': 1.0,
             })

pgm.add_node("scurvy_prevention", "Scurvy\nPrevention", 7, 1, aspect=3.2, scale=1.5,
             plot_params={
...
# Add edges showing the correct causal chain
pgm.add_edge("vitamin_c", "collagen")
pgm.add_edge("collagen", "scurvy_prevention")

# Render the DAG
pgm.render()
plt.title("DAG 3: 1928 Understanding - Vitamin C → Collagen → Scurvy Prevention (CORRECT)", fontsize=14, fontweight='bold')
plt.show()
```
